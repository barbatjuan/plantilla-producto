...
function nvm_vr_bootstrap() {
	...
	require_once NVM_VR_PATH . 'includes/class-nvm-vr-side-cart.php';
	require_once NVM_VR_PATH . 'includes/class-nvm-vr-product-builder.php';
	require_once NVM_VR_PATH . 'includes/class-nvm-vr-archive-builder.php';
	require_once NVM_VR_PATH . 'includes/class-nvm-vr-quantity.php';
	require_once NVM_VR_PATH . 'includes/class-nvm-vr-mini-cart.php';
	...
	NVM_VR_Archive::init();
	NVM_VR_Archive_Builder::init();
	NVM_VR_Quantity::init();
	NVM_VR_Mini_Cart::init();
