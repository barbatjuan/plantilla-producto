 ...
 * Description:          Renders variable product variations as selectable rows with per-variation price, discount badge and unit price, and applies the extra discount as a real cart rule. The native WooCommerce variation form stays in charge.
 * Version:              1.0.8
 * Author:               Juan Barbat
